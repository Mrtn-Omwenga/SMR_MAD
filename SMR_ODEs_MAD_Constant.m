function dydt = SMR_ODEs_Base_Constant(t, y, params, scenario)
% SMR_ODEs_Base_Constant.m - Base Model with Constant Demand
...
% External reactivity - CONSTANT DEMAND
rho_ext = SMR_Reactivity_ConstantDemand(t, y, params, scenario, 0.78);
